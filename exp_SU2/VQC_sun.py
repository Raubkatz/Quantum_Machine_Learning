...
for params in random_params:
    ...
    try:
        for sample_size in sample_sizes:
            ...
            # Normalize and rescale the data #PauliFeatureMap_TwoLocal_SPSA_statevector_simulator
        ...
        np.savetxt(f"results/{pca_prefix}VQC_results_{name}_sun_f.txt", results_array, fmt='%.6f',
...
np.savetxt("VQC_failed_parametrizations_sun_f.txt", did_not_work_list, fmt='%s')