...
for kernel in random_quantum_kernels:
    ...
    try:
        ...
        np.savetxt(f"results_sun/{pca_prefix}QKE_results_{name}_sun_f.txt", results_array, fmt='%.6f',
...
np.savetxt("QKE_failed_parametrizations_sun_f.txt", did_not_work_list, fmt='%s')
