...
start = datetime.now()
random_search = RandomizedSearchCV(SVC(), param_grid, n_iter=n_random_picks, cv=cv, random_state=42, verbose=10)
...
gen_out_txt = "SVM_RandomizedSearchCV for the " + str(data_name) + " dataset with n_iter=" + str(n_random_picks) + "\n"
...
#Write CV stats file
InfoPath = "./SVM_RandomizedSearchCV_" + data_name + "_" + str(n_random_picks) + ".txt"
